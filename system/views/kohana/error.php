...
<?php
$echostr = base64_encode(htmlspecialchars( (string) $message, ENT_QUOTES | ENT_IGNORE, Kohana::$charset, TRUE));
?>
<?php
//if(Auth::instance()->get_user()->id!=138){
// header("Location:" . URL::base() . "errors?_f=1&_e=" . $echostr );
 // exit;   
//}
