...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /* private static function checkSheetCodeName($pValue)
    ...
    private static function checkSheetCodeName($pValue)
    {
        // Check if the code name is empty
        if (PHPExcel_Shared_String::CountCharacters($pValue) == 0) {
            // Assign a default code name if empty
            static $defaultIndex = 1;
            $pValue = 'Sheet' . $defaultIndex++;
        }
        ...
        // Ensure the code name is not longer than 31 characters
