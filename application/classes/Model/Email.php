...
class Model_Email {
    ...
    public static function user_request($reference_id, $user_id, $request_type, $company_name, $status, $requested_value, $concerned_person_id, $projectids, $startDate, $endDate, $reason) {
        ...
        $query = DB::insert('user_request', array('reference_id', 'user_id', 'user_request_type_id', 'company_name', 'status', 'concerned_person_id', 'project_id', 'requested_value', 'startDate', 'endDate', 'reason', 'request_priority'))
                ->values(array($reference_id, $user_id, $request_type, $company_name, $status, $concerned_person_id, $projectids, $requested_value, $startDate, $endDate, $reason, $request_priority))
                ->execute();
