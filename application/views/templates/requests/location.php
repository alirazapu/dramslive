        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div id="headerdiv" class="box-header with-border">
                    <h3 class="box-title">Request Current Location Against Mobile Number </h3>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            url: "<?php echo URL::site("userrequest/locrequestpermission"); ?>",
            type: 'POST',
            data: result,
            cache: false,
...
//            }else {
//            
//            swal("Zong Telco System Error", "Contact CDR Section HQ Team (04236525257).", "error");
//            
//            }
        }
