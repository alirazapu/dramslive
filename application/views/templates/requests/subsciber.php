        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div id="headerdiv" class="box-header with-border">
                    <h3 class="box-title">Request Subscriber Against Mobile Number</h3>
                        ...
                        <div id="dataform">
                            <div class="col-sm-6" id="sub_div" style="">
                                <div class="form-group" style="">                                                            
                                    ...
                                    <input type="text" class="form-control" name="inputSubNO" id="inputSubNO" value="<?php echo ($msisdn != 0) ? $msisdn : ''; ?>" placeholder="e.g. 3001234567" readonly>
                                </div>
                            </div>
                                ...
                                <div class="form-group"  >
                                    ...
                                    <div class="col-sm-12" id="rqtfile_div">
                                        <div class="form-group">
                                            ...
                                            <!-- See cdrmsisdn.php for the full
                                                 explanation; behaviour is owned
                                                 by dist/js/requested_attachment.js. -->
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            url: "<?php echo URL::site("userrequest/subrequestpermission"); ?>",
            type: 'POST',
            data: result,
            cache: false,
    ...
    function submitrequestform() {
        // FormData (not serializeArray) is required so that the optional
        // "Requested Attachment" file input on this form actually rides
        // the POST. serializeArray() silently drops <input type="file">.
        // The processData/contentType:false flags preserve the multipart
        // boundary jQuery would otherwise replace.
