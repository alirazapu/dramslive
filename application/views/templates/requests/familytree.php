            ...
            <div class="box box-primary">
                ...
                <form class="ipf-form request_net" name="requestform" id="userrequest" method="post" enctype="multipart/form-data" >
                    <div class="box-body">
                        ...
                        <input type="hidden" id="ChooseTemplate" name="ChooseTemplate" value="10" placeholder="value 10 for family tree request" />
                        <div id="dataform">
                            <div class="col-sm-6" id="sub_div" style="">
                                <div class="form-group" style="">                                                            
                                    <label for="inputCNIC" class="control-label">CNIC Number</label>                                                                                                                        
                                    <input type="text" class="form-control" name="inputCNIC" id="inputCNIC" value="<?php echo ($cnicnumber != 0) ? $cnicnumber : '';?>" readonly>
                                </div>
                            </div>
                            <div class="col-sm-6" id="" style="">
                                <div class="form-group"  >
                                    ...
                                    <select readonly class="form-control" name="company_name_get[]" id="company_name_get" style="width: 100%;">                                        
                                        <option value="13" selected>NADRA</option>
                                    </select>
                                </div>
                            </div>
