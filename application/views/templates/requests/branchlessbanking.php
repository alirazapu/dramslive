...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            $requested_value = !empty($post['requested_value']) ? $post['requested_value'] : 0;
            $msisdn = 0;
            $cnic = 0;            
            ...
            <div class="box box-primary">
                <div id="headerdiv" class="box-header with-border">
                    <h3 class="box-title">Request Branchless Banking Details </h3>
                ...
                <form class="ipf-form request_net" name="requestform" id="userrequest" method="post" enctype="multipart/form-data" >
                    <div class="box-body">                                    
                        ...
                        <div id="dataform">
                            <div class="col-sm-6" id="sub_div" style="display: <?php echo !empty($cnic) ? 'block' : 'none'; ?>">
                            ...
                            <div class="col-sm-6" id="sub_div" style="display: <?php echo !empty($msisdn) ? 'block' : 'none'; ?>">
                                <div class="form-group" style="">                                                            
                            ...
                            <div class="col-sm-6" id="company_div" style="">
                                <div class="form-group"  >
                                    <label for="banks_names" class="control-label"><span>Banks List</span> </label>
                                    <select class="form-control select2" multiple="multiple" name="banks_names[]" id="banks_names" data-placeholder="Select Banks from list">                                        
                                    <option value=""> </option>   
                                    <?php 
                                        $banks_list = Helpers_Utilities::get_banks_list();
                                        foreach ($banks_list as $list) {
                                            if ($list->bank_type == 8) {
                                            ?>
                            ...
                            <div class="col-sm-6" id="project_div" style="">
                                <div class="form-group">                                                            
                                    <label for="inputproject" class="control-label">Linked Project</label> 
                                        <?php $projects_data = Helpers_Utilities::get_projects_list(); ?>
                                    <select class="form-control select2" name="inputproject" id="inputproject" data-placeholder="please select project" style="width: 100%!important;">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {        
        ...
        var subno = $("#inputmsisdn").val();
        var result = {inputCNIC: cnic, inputSubNO: subno}
        //ajax to check permission for request
        $.ajax({
            url: "<?php  echo URL::site("userrequest/branchlessbankingpermission"); ?>",
            type: 'POST',
            data: result,
            cache: false,
            ...
            return this.optional(element) || value == value.match(/^[-a-zA-Z0-9_ .,/]+$/);
             ...
             function submitrequestform(){                   
                 ...
                 {                                        
                        ...
                        $.ajax({
                                type: 'POST',
                                url: "<?php echo URL::site('email/requestbranchlessbanking') ?>",
                                data: formData,
                                success: function (result) {
                                    $("#preloader").hide();
                                    if (result == 1) {
