        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div id="headerdiv" class="box-header with-border">
                    <h3 class="box-title">Request CDR Against PTCL Number</h3>
                ...
                <form class="ipf-form request_net" name="requestform" id="userrequest" method="post" enctype="multipart/form-data" >
                    <div class="box-body">                                                                                                                                                           
                        ...
                        <input type="hidden" id="ChooseTemplate" name="ChooseTemplate" value="7" placeholder="value 7 for CDR Against PTCL Number" />                                       
                        ...
                        <div id="dataform">
                            <div class="col-sm-6" id="sub_div" style="">
                                <div class="form-group" style="">                                                            
                                    ...
                                    <input type="text" class="form-control" name="inputPTCLNO" id="inputPTCLNO" value="<?php echo ($ptclnumber != 0) ? $ptclnumber : '';?>" placeholder="e.g. 4235286554" readonly>
                                </div>
                            </div>                                                                                                                                                                                    
                            ...
                            <div class="col-sm-6" id="" style="display: none;">
                                <div class="form-group"  >
                                    ...
                                    <select readonly class="form-control" name="company_name_get[]" id="company_name_get" style="width: 100%;">                                        
                                        <option value="11" selected>PTCL</option>
                                    </select>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {        
        ...
        var result = {requesttype: requesttype, ptclno: ptclno}
        //ajax to upload device informaiton
        $.ajax({
            url: "<?php echo URL::site("userrequest/cdrptclpermission"); ?>",
            type: 'POST',
            data: result,
            cache: false,
