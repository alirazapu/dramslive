        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div id="headerdiv" class="box-header with-border">
                    <h3 class="box-title">Request Subscriber Against PTCL Number</h3>
                ...
                <form class="ipf-form request_net" name="requestform" id="userrequest" method="post" enctype="multipart/form-data" >
                    <div class="box-body">
                        ...
                        <input type="hidden" id="ChooseTemplate" name="ChooseTemplate" value="11" placeholder="value 11 for Subscriber Against PTCL Number" />
                        <div id="dataform">
...
<script type="text/javascript">
    $(document).ready(function () {        
        ...
        $.ajax({
            url: "<?php echo URL::site("userrequest/subptclpermission"); ?>",
            type: 'POST',
            data: result,
            cache: false,
