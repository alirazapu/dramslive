...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo URL::site('persons/sms_summary/?id='.$_GET['id']); ?>">SMS Summary </a></li>
        <li class="active">SMS Summary Detail</li>
    </ol>
</section>
<!-- Main content -->
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-mobile-phone"></i> SMS Summary Detail</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="smssummarydetail" class="table table-bordered table-striped">
                            <thead>
                                <tr>                                    
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#smssummarydetail').dataTable(
                {//"aaSorting": [[2, "desc"]],
                    "bPaginate": true,
                    "bProcessing": true,
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('persons/ajaxsmssummarydetail/?id='.$_GET['id'], TRUE); ?>",
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('persons/sms_summary_detail/?id='.$_GET['id'], TRUE); ?>';
    }
