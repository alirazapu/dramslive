    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                ...
                <form role="form" id="call_summary_form" name="search_form" method="post"  action="<?php echo URL::site('persons/sms_summary/?id='.$_GET['id']); ?>" >
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-mobile-phone"></i> SMS Summary of <?php echo Helpers_Person::get_person_name($person_id); ?> </h3>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        ;
        objDT = $('#smstable').dataTable(
                {"aaSorting": [[4, "desc"]],
                    "bPaginate": true,
                    "bProcessing": true,
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('persons/ajaxsmssummary/?id='.$_GET['id'], TRUE); ?>",
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('persons/sms_summary/?id='.$_GET['id'], TRUE); ?>';
    }
