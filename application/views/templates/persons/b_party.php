    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                ...
                <form role="form" id="call_summary_form" name="search_form" method="post"  action="<?php echo URL::site('persons/b_party/?id='.$_GET['id']); ?>" >
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-mobile-phone"></i> B-Party of <?php echo Helpers_Person::get_person_name($person_id); ?></h3>
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="cdrtable" class="table table-bordered table-striped">
                                <thead>
                                    <tr>                                                    
...
// draw the 'current' page
        ...
        objDT = $('#cdrtable').dataTable(
           // alert('tttt');
                {"aaSorting": [[2, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('persons/ajax_b_party/?id='.$_GET['id'], TRUE); ?>",
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('persons/b_party/?id='.$_GET['id'], TRUE); ?>';
    }
