            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-mobile-phone"></i> CDR Summary of <?php echo Helpers_Person::get_person_name($person_id); ?></h3>
...
// draw the 'current' page
        ...
        objDT = $('#cdrtable').dataTable(
                {"aaSorting": [[3, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('persons/ajaxcdrsummary/?id='.$_GET['id'], TRUE); ?>",
