    ...
    <div class="row">
                            ...
                            <div class="box-body" style="<?php echo (!empty($search_post)) ? 'display:block;' : ''; ?>">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control " name="type" id='type' onchange="showDiv(this)">                                                        
                                            ...
                                            <option <?php echo ((!empty($search_post['type']) && ($search_post['type'] == 'curloc')) ? 'selected' : ''); ?> value="curloc"> Current Location</option>                                        
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  readonly="readonly" placeholder="hh:mm" class="form-control" id="starttime" value="<?php echo (!empty($search_post['starttime']) ? $search_post['starttime'] : ""); ?>" name="starttime">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="endtime">End Time</label>
                                        <input  readonly="readonly" type="text" placeholder="hh:mm" class="form-control" id="endtime" value="<?php echo (!empty($search_post['endtime']) ? $search_post['endtime'] : ''); ?>" name="endtime">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-1" style="width: 10%">
                                    ...
                                    <select class="form-control select2" name="limit" id="limit">                                                        
                                        ...
                                        <option <?php echo ((!empty($search_post['limit']) && ($search_post['limit'] == 1)) ? 'selected' : ''); ?> value="1"> All </option>
                                    </select>
                                </div>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Person's Current Location/Call Location</h3>
...
function person_location() {
       ...
       // alert(type);
        ...
        {
            jQuery("#limit").select2().select2('val', [limit]);
            $("#otherphone").attr("disabled", false);            
            $('#otherphone').removeAttr("readonly");
            $('#limit').removeAttr("readonly");
        }
        var searchresults = {type: type, phonenumber: phonenumber, otherphone: otherphone, sdate: sdate, edate: edate,starttime:stime, endtime: etime, limit :limit, id: '<?php echo $_GET['id'];?>'}        
        $.ajax({
...
$("#search_form").validate({
        ...
        messages: {
            ...
            // },
            endtime: {
                required: "Required With Start Time",
            },
            edate: {
                required: "Required With Start Date",
            },
        }
    });
...
function showDiv(elem) {
        ...
        {
            jQuery("#limit").select2().select2('val', ['5']);
            $("#otherphone").attr("disabled", false);
            $('#otherphone').removeAttr("readonly");
            $('#limit').removeAttr("readonly");
        }
