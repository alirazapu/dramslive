    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                ...
                <form role="form" id="search_form" name="search_form" class="sms_log_summary" method="post"  action="<?php echo URL::site('persons/sms_log_summary/?id='.$_GET['id']); ?>" >
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    <?php if(!empty($search_post['st'] && $search_post['et'])){ ?>
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-mobile-phone"></i> SMS LOG of <?php echo Helpers_Person::get_person_name($person_id) .' Between '. $search_post['st'].' to '.$search_post['et']; ?></h3>
                   <a title="Export to Excel" href="javascript:excel()" class="btn btn-danger btn-small" style="float: right;"><i class="fa fa-file-excel-o"></i>  Export</a>
                    ...
                    <?php }else{ ?>
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-mobile-phone"></i> SMS LOG of <?php echo Helpers_Person::get_person_name($person_id); ?></h3>
                        <a title="Export to Excel" href="javascript:excel()" class="btn btn-danger btn-small" style="float: right;"><i class="fa fa-file-excel-o"></i>  Export</a>
                    </div>
                    <?php } ?>
                    <!-- /.box-header -->
    ...
    $(document).ready(function () {
        ...
        objDT = $('#smslogtable').dataTable(
                {"aaSorting": [[3, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('persons/ajaxsmslogsummary/?id='.$_GET['id'], TRUE); ?>",
