...
<!---->
<!--                <form role="form" id="call_summary_form" name="search_form" method="post"  action="--><?php //echo URL::site('persons/cdr_summary/?id='.$_GET['id']); ?><!--" >-->
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-mobile-phone"></i> Short Code Analysis of <?php echo Helpers_Person::get_person_name(Helpers_Utilities::encrypted_key($_GET['id'], "decrypt")); ?></h3>
<!--                        <h3 class="box-title"><i class="fa fa-mobile-phone"></i> Short Code Analysis of --><?php //echo Helpers_Person::get_person_name($person_id); ?><!--</h3>-->
<!--                    <a title="Export to Excel" href="javascript:excel()" class="btn btn-danger btn-small" style="float: right;"><i class="fa fa-file-excel-o"></i>  Export</a>                        -->
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="shortcode_analysis_table" class="table table-bordered table-striped">
                                <thead>
                                    <tr>                                                    
                                ...
                                <tfoot>
                                    <tr>
                                        <th class="no-sort">Company Namer</th>
                                        <th class="no-sort">Code</th>
                                        <th>SMS</th>
                                        <th>Call</th>
                                    </tr>
...
// draw the 'current' page
        ...
        objDT = $('#shortcode_analysis_table').dataTable(
                {//"aaSorting": [[2, "desc"]],
                    "bPaginate": true,
                    "bProcessing": true,
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('persons/ajax_shortcode_analysis/?id='.$_GET['id'], TRUE); ?>",
                    "sPaginationType": "full_numbers",
                    "bFilter": true,
                    "bLengthChange": true,
                    "oLanguage": {
                        "sProcessing": "Loading...",
                        "sSearch": "Search By Code:"
