    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                ...
                $project_name = ( isset($project_id) ) ? Helpers_Utilities::get_project_names($project_id) : 'NA';
                ?>
                <form role="form" id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userreports/project_request_send_detail/?userid=' . $search_post['userid'] . '&request_type=' . $search_post['request_type'] . '&project_id=' .$search_post['project_id'] ); ?>" >
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-search"></i> Request Send Log of: <u> <?php echo $user_name ?></u> &nbsp; against <u><?php echo $request_type ?></u>  &nbsp; Project: <u><?php echo $project_name ?></u></h3>
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requestsend').dataTable(
                {//"aaSorting": [[2, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userreports/ajaxprojectrequestsenddetail', TRUE); ?>",
