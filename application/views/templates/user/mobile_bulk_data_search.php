    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                ...
                <?php } ?>
                <form name="mobile_bulk_data_search" id="mobile_bulk_data_search" action="<?php echo URL::site('user/mobile_bulk_data_search'); ?>" method="post" enctype="multipart/form-data">
                    <div class="box-body"> 
                        <div class="col-md-6">
                            <div class="form-group col-md-12">
                                <label ><u>Bulk Data Search Instructions!</u></label>
                                <p><u>1.</u> Please make sure that uploaded file is in excel format, sheet one, column A containing Mobile numbers without dashes and first 0.</p>
                                ...
                                <p><u>2.</u> In case of error in uploaded file, try again after following above instructions.</p>                                
                            </div>
                            ...
                            <div class="form-group col-sm-12">                               
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="search_type" id="search_type">                                          
                                        <option <?php echo (( isset($search_post['search_type']) && ($search_post['search_type'] == '1')) ? 'selected' : ''); ?> value="1">Mobile Number</option>
                                    </select>
                                </div>                            
                            </div>                                                                
                            <div class="form-group col-sm-12">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-search"></i> Persons with given Number</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <table id="searchperson" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="no-sort"  style="width: 8%">Phone #</th>
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="bpartysearch" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th style="width: 15%">Requested b-party</th>
                                        <th style="width: 15%">A-party</th>                                        
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-search"></i> Bulk Offline Subscribers</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="bpartysearchsub" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th style="width: 15%">Given Number</th>
                                        <th style="width: 75%">Subscriber</th>  
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        "bPaginate": true,
                ...
                //  //"bStateSave": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo URL::site('user/ajaxmobilebulkdatasearch', TRUE); ?>",
        ...
        [10, 25, 50,100, 500]
         ...
         objDT = $('#bpartysearch').dataTable( 
                {//"aaSorting": [[2, "desc"]],
                  ...
                  //  //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('user/ajaxbpartybulksearch', TRUE); ?>",
                    "sPaginationType": "full_numbers",
                    "bFilter": false,
                    "bLengthChange": true,
                                lengthMenu: [
...
objDT = $('#bpartysearchsub').dataTable( 
                {//"aaSorting": [[2, "desc"]],
                    "bPaginate": true,
                    "bProcessing": true,
                  //  //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('user/ajaxbpartybulksearchsub', TRUE); ?>",
                    "sPaginationType": "full_numbers",
                    "bFilter": false,
                    "bLengthChange": true,
                                lengthMenu: [
...
// validation for data search
        $("#mobile_bulk_data_search").validate({
            errorElement: 'span',
            rules: {
                search_type: {
                    required: true
            ...
            submitHandler: function () {
                $("#mobile_bulk_data_search").submit();
