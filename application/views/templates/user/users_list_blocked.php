    ...
    <div class="container-fluid">
        <div class="">
            ...
            <div class="box box-primary">
                ...
                <form id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userreports/users_list_blocked'); ?>">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-list"></i> Blocked User's List</h3>
    ...
    $(document).ready(function () {  
        ...
        objDT = $('#userslist').dataTable(
                {//"aaSorting": [[2, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userreports/ajaxuserslistblocked', TRUE); ?>",
...
$("#search_form").validate({
 ...
 function showDiv(elem) {
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('userreports/users_list_blocked', TRUE); ?>';
    }
    function excel(id){          
            $('#xport').val('excel');
            $('#search_form').submit();            
   ...
   function ConfirmChoiceUnBlock(id) 
    { 
       ...
       // var elem = $(this).closest('tr[class^="action"]');       
        ...
        $.confirm({
            'title'     : 'Un-Block user confirmation',
            'message'   : 'Do you really want to Un-Block this user?' ,
            'buttons'   : {
                'Yes'   : {
                    'class' : 'gray',
                    'action': function(){        
                        $.ajax({url: '<?php echo URL::base() . "user/userUnBlock/"; ?>'  + id , success: function(result){ 
                                if (result == '-2') { 
