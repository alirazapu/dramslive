                ...
                <form class="ipf-form request_net" name="requestform" id="userrequest" method="post"
                    ...
                    <div class="col-sm-6" id="reason_div">
                        <div class="form-group">
                            ...
                            <input type="file" accept=".jpg,.pdf,.gif,.png" id="rqtfile" name="rqtfile"
...
<script type="text/javascript">
    ...
    function submitrequestform() {
        ...
        if ($('#userrequest').valid()) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo URL::site('adminrequest/admin_travel_send') ?>",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
                success: function (result) {
                    ...
                    if (result == 1) {
                        swal({
                            ...
                            function (isConfirm) {
                                if (isConfirm) {
                                    window.location.href = '<?php echo URL::site('adminrequest/travel_request_sent_form', TRUE); ?>';
                                } else {
...
function refreshGrid() {
        ...
        objDT1 = $('#requeststatus').dataTable(
            {"aaSorting": [[6, "desc"]],
                ...
                //"bStateSave": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo URL::site('adminrequest/ajax_travel_request_status', TRUE); ?>",
...
// alert('test');
    ...
    function UpdateRequestStatusDetails() {
        ...
        $.ajax({
            url: "<?php echo URL::site("adminrequest/update_travel_request_status"); ?>",
            type: 'POST',
            data: result,
            cache: false,
            success: function (result) {
