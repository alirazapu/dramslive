                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"><i class="fa fa-list"></i> Error Page</h3>                        
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pad">
                                        ...
                                        <img id="nodata" style=" " class="img-responsive" src="<?php echo URL::base() . 'dist/img/errorpage.png'; ?>" alt="No Data">
                                    </div>                                                                                          
