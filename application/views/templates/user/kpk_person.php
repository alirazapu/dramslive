                            ...
                            <table id="kpkperson" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="160">Person Info</th>
                                        <th width="100">Address</th>
                                        <th width="100">Motive</th>
                                        <th>Case Info</th>
                                        <th width="170">Other Info</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    $(document).ready(function () {
        ...
        objDT = $('#kpkperson').dataTable(
                {"aaSorting": [[1, "desc"]],
                   ...
                   // "bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('user/ajaxkpkperson', TRUE); ?>",
                    "sPaginationType": "full_numbers",
                    "bFilter": true,
                    "bLengthChange": true,
                    "oLanguage": {
                        "sProcessing": "Loading...",
                        "sSearch": "Search by Name or CNIC:",
