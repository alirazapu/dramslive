...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Nadra Requests</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="container-fluid">
        ...
        <div class="box box-primary">
            <div class="box">                 
                ...
                <form role="form" name="search_form" id="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('admindatabank/nadra_requests_databank'); ?>" >
...
?>                                                     
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Nadra Request Status</label>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="col-xs-4">
                            <h3 class="box-title"><i class="fa fa-list"></i> Nadra Request</h3>
                        </div>
                        <div class="col-xs-4">
                            <a title="Upload Bulk Verisys" href="javascript:uploadbulkverisys()" class="btn btn-primary btn-small" style="float: right;"><i class="fa fa-upload"></i>  Upload Bulk Verisys</a>
                        </div>
                        <div class="col-xs-4">
...
<div class="modal modal-info fade" id="process_nadra_verysis">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Proceed Nadra Verysis Request</h4>
            </div>
            <form class="" name="veriysispics" id="veriysispics" action="<?php echo url::site() . 'personprofile/admin_update_personverysisrequest/' ?>"  method="post" enctype="multipart/form-data" >
                ...
                <div class="modal-body" style='background-color: #fff !important; color: black !important; '>
                    ...
                    <div id="manualuploadimeicdr" style="display:block;margin-top: 5px;margin-bottom: 5px;" class="col-md-12">                                            
                        ...
                        <div class="col-md-12" style="background-color: #fff;color: black">
                            ...
                            <div class="form-group col-md-12"> 
                                <label for="personverysis">Upload<small>   (JPG,GIF and PNG files only)</small></label>
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requeststatus').dataTable(
                {"aaSorting": [[4, "desc"]],
                    ...
                    "mark": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('admindatabank/ajaxusernadrarequests_databank', TRUE); ?>",
...
//    });
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('admindatabank/nadra_requests_databank', TRUE); ?>';
    }
    function excel(){    
            $('#xport').val('excel');
            $('#search_form').submit();            
    ...
    function uploadbulkverisys(){   
        window.location.href = '<?php echo URL::site('admindatabank/bulk_nadra_requests_databank', TRUE); ?>';
    }
    ...
    function requeueverisys(request_id){
        ...
        $.ajax({
            url: "<?php echo URL::site("admindatabank/request_requeue_verisys_databank"); ?>",
            type: 'POST',
            data: result,
            cache: false,
            //dataType: "text",
