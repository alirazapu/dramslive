...
<section class="content-header">
    <h1>
        ...
        Most Active IMEI Sims
        <small>Tracer</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo URL::site('Userdashboard/dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Active IMEI Sims</li>
    </ol>
</section>
<!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-search"></i> Sims Against Active IMEI Number</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <table id="bpartysearch" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Status</th>
                                        <th class="no-sort">Usage Detail</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    $(document).ready(function () {
        ...
        objDT = $('#bpartysearch').dataTable( 
                {"aaSorting": [[1, "desc"]],
                   ...
                   // "bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('user/ajaxsimsagainstimei/?id='.$search_post['imei_id'], TRUE); ?>",
