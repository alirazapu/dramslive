...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requeststatus').dataTable(
                {"aaSorting": [[5, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userrequest/ajaxuserrequeststatusufone', TRUE); ?>",
    ...
    function requestmanualsent(request_id, id) {
        $.ajax({url: '<?php echo URL::base() . "Userrequest/manualrequestsend/"; ?>' + request_id, success: function (result) {
            refreshGrid();    
            window.open('<?php echo URL::base() . "Userrequest/request_status_detail/"; ?>' + id, '_blank');
        }});
    }    
