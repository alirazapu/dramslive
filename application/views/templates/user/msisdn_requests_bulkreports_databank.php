...
//exit();
$uid = $user_id;
//$user_name=$search_post['user_name'];
//$date_from=$search_post['datefrom'];
//$date_to=$search_post['dateto'];
//echo '<pre>';
//print_r($uid);
//exit();
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">User's Reports</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                <form role="form" name="search_form" id="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('admindatabank/msisdn_requests_reports_databank'); ?>" enctype="multipart/form-data" >
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requestsend').dataTable(
            {//"aaSorting": [[3, "desc"]],
                ...
                "mark": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo URL::site('admindatabank/ajaxdatabank_msisdn_requests_reports?uid=' . $uid, TRUE); ?>",
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('admindatabank/msisdn_requests_reports_databank', TRUE); ?>';
    }
