...
<section class="content-header">
    <h1>
        ...
        Panel Log/Office Wise History
        <small>DRAMS</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo URL::site('Userdashboard/dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Panel Log/Office Wise History</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                <form id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userreports/panel_log_officewise'); ?>">
                            ...
                            <div id="key-hide">
                             ...
                             <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input  autocomplete="false" type="text"   placeholder="mm/dd/yyyy hh:mm" class="form-control form_datetime" id="sdate" value="<?php echo (!empty($search_post['sdate']) ? $search_post['sdate'] : ""); ?>" name="sdate">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input  autocomplete="false"  type="text" placeholder="mm/dd/yyyy hh:mm" class="form-control form_datetime" id="edate" value="<?php echo (!empty($search_post['edate']) ? $search_post['edate'] : ''); ?>" name="edate">
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table id="penallog" class="table table-bordered table-striped" >
                                <thead>
                                    <tr>                                        
                                        <th >Office Name</th>
                                       <th  class="no-sort">Activities Count</th>
                                    </tr>
                                </thead>
                                <tbody>
...
<script type="text/javascript">
    ...
    $('#datetime').datepicker({
     ...
     $("#sdate").datetimepicker({format: 'mm/dd/yyyy hh:ii'});
     $("#edate").datetimepicker({format: 'mm/dd/yyyy hh:ii'});
...
//                    "colReorder" : true,
                    ...
                    "mark": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userreports/ajaxpanellogpostingwise', TRUE); ?>",
                    "sPaginationType": "full_numbers",
                    "bFilter": true,                    
                    "bLengthChange": true,
                    "oLanguage": {
                        "sProcessing": "Loading...",
                        "sSearch": "Search By Office Name:"
                    },
                    "columnDefs": [{
                            "targets": 'no-sort',
                            "orderable": false,
