...
<div class="errorPageRap">
  <div class="holoContainer">
    ...
    <svg class="holoPad" width="25.6rem" height="27.8rem" viewBox="0 0 226 242" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <h1>
            You are Blocked..... <span><img src="http://danielwolf.cc/codepen/errorpage/sadFace.png"></span>
            <br>
            Please Contact to <a> SMART </a> Administrator
            <br>
                ...
                <?php                 
                    if(!empty($_GET) && !empty($_GET['id']))
                    {
                        ...
                        {
                            case 1:
                                echo "Your's IP Blocked in AIES";
                                break;
                            case 2:
                                echo "You enter wrong URL";
                                break;
