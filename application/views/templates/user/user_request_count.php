...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">User Request Count</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                <form role="form" name="search_form" id="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('Adminrequest/user_request_count'); ?>" >
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requeststatus').dataTable(
            {"aaSorting": [[1, "desc"]],
                ...
                //"bStateSave": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo URL::site('adminrequest/ajaxuserrequestcount', TRUE); ?>",
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('adminrequest/user_request_count', TRUE); ?>';
    }
