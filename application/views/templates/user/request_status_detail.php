                    ...
                    <div class="row request_status_detail">
                        <div id="request_status" style="margin:15px; margin-left: 115px; margin-right: 115px;">
                            ...
                            if ($difference >= 2 && ($permission == 5 || $permission == 1 || $permission == 2)) {
                                ...
                                ?>
                                <a style="" target="" href="<?php echo URL::base() . '/userrequest/request_resend?request_id=' . $rqtid ?>"
                                   class="btn btn-warning pull-right">Request Re-queue</a>
                            <?php } ?>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                ?>
                                <input disabled type="text" class="form-control" id="user_name" name="user_name" value="<?php echo $userdetails; ?>"
                                       placeholder="">
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                ?>
                                <input disabled type="text" class="form-control" id="user_name" name="user_name" value="<?php echo $usertype; ?>"
                                       placeholder="">
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                ?>
                                <input disabled type="text" class="form-control" id="user_name" name="user_name" value="<?php echo $userdesignation; ?>"
                                       placeholder="">
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                ?>
                                <input disabled type="text" class="form-control" id="user_name" name="user_name" value="<?php echo $userposting; ?>"
                                       placeholder="">
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                ?>
                                <input disabled type="text" class="form-control" id="company_name" name="company_name"
                                       value="<?php echo isset($comp->company_name) ? $comp->company_name : "N/A"; ?>" placeholder="Requested Value">
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                ?>
                                <input disabled type="text" class="form-control" id="Request_type" name="Request_type" value="<?php echo $rqts; ?>"
                                       placeholder="">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="Request_sentcount">Sent(count)</label>
                                <input disabled type="text" class="form-control" id="Request_sentcount" name="Request_sentcount"
                                       value="<?php echo $results['request_send_count']; ?>" placeholder="">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="requested_value">Requested Value</label>
                                <input disabled type="text" class="form-control" id="requested_value" name="requested_value"
                                       value="<?php echo $results['requested_value']; ?>" placeholder="">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="requst_time">Request Time</label>
                                <input disabled type="text" class="form-control" id="requst_time" name="requst_time"
                                       value="<?php echo $results['created_at']; ?>" placeholder="">
                            </div>
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3" style="display: <?php echo $display; ?>">
                                ...
                                <input disabled type="text" class="form-control" id="requested_value" name="requested_value"
                                       value="<?php echo $results['sending_date']; ?>" placeholder="">
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                ?>
                                <input disabled type="text" class="form-control" id="reason" name="reason" value="<?php echo $parsing_status; ?>"
                                       placeholder="">
                            </div>
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input disabled type="text" class="form-control" id="project" name="project" value="<?php echo $projectslist; ?>"
                                       placeholder="">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="reason">Reason of Request</label>
                                <input disabled type="text" class="form-control" id="reason" name="reason" value="<?php echo $results['reason']; ?>"
                                       placeholder="">
                            </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input disabled type="text" class="form-control" id="subject" name="subject"
                                               value="<?php echo $results['message_subject']; ?>">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="body">E-Mail Body</label>
                                        <textarea disabled style="height: 200px; border: 1px solid;" class="form-control" id="body"
                                                  name="body"><?php echo strip_tags($results['message_body']); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input disabled type="text" class="form-control" id="subject" name="subject" value="<?php echo $download_file_name; ?>"
                                               placeholder="File Path if any">
                                    </div>
                                    <?php
                                    if (!empty($file_id) && (!empty($download_file_name))) {
                                        $file_id = Helpers_Utilities::encrypted_key($file_id, 'encrypt')
                                        ?>
                                        <form class="" name="download" action="<?php echo url::site() . 'personprofile/download' ?>" id="downloadfile"
                                    ...
                                    <div class="form-group col-md-12">
                                        <?php
                                        // Put this helper once near the top of the view (before your HTML)
                                        if (!function_exists('view_try_decode_email_body')) {
                                            function view_try_decode_email_body($body)
                                            {
                                                if ($body === '' || $body === null) {
                                                    return $body;
                                                }

                                                // Replace %20 with space (your existing behaviour)
                                                $body = str_replace('%20', ' ', $body);

                                                $decoded = $body;

                                                // Try base64 decode if it looks like base64 (e.g., your MzE2... case)
                                                if (preg_match('/^[A-Za-z0-9+\/=\r\n]+$/', $body)) {
                                                    $b64 = base64_decode($body, true);
                                                    if ($b64 !== false && $b64 !== '') {
                                                        $decoded = $b64;
                                                    }
                                                }

                                                // Always try quoted-printable decode as well
                                        ...
                                        <div style="" id="body">
                                            <label for="body">Received Body
                                                ...
                                                <a style="cursor: pointer; font-size: 11px;"
                                                   data-toggle="popover"
                                                   title="Ecoded Body Message"
                                                   data-content="<?php echo htmlspecialchars($results['received_body'], ENT_QUOTES, 'UTF-8'); ?>">
                                                    Encoded Body
                                                </a>

                                            </label>
                                            <textarea id="body_txt"
                                                      readonly
                                                      name="body"
                                                      class="textarea form-control"
                                                      placeholder="Please enter template format heare with the help of tokens"
                                                      style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
<?php
// Prefer decoded "raw" body
if (!empty($results['received_body_raw']) && $results['received_body_raw'] !== 'na') {
    echo htmlspecialchars(view_try_decode_email_body($results['received_body_raw']), ENT_QUOTES, 'UTF-8');
} elseif (!empty($results['received_body']) && $results['received_body'] !== 'na') {
    echo htmlspecialchars(view_try_decode_email_body($results['received_body']), ENT_QUOTES, 'UTF-8');
} else {
    echo '';
}
?>
                                        ...
                                        <div class="col-md-12">
                                            <form class="" name="fixerror" id="fixerror" action="<?php if ($results['user_request_type_id'] == 2) {
                                                ...
                                                <textarea hidden="" type="text"
                                                          name="receivedbody"><?php echo '<br>' . 'Company: ' . $comp->company_name . ' <br> ' . ',    Project:' . $projectslist . ' <br> ' . $results['received_body']; ?>"</textarea>
                                                <textarea hidden="" type="text"
                                                          name="receivedbodyraw"><?php echo '<br>' . 'Company: ' . $comp->company_name . ' <br> ' . ',    Project:' . $projectslist . ' <br> ' . $results['received_body_raw']; ?>"</textarea>
                                            ...
                                            <form class="" name="process_complete" id="process_complete"
                                                  action="<?php echo url::site() . 'user/mark_complete' ?>" method="post">
                                                ...
                                                if ($results['user_request_type_id'] != 8 && $results['processing_index'] == 3 && (($permission == 2 || $permission == 5 || $permission == 1) || (($permission == 4) && ($results['user_request_type_id'] == 1 || $results['user_request_type_id'] == 2 || $results['user_request_type_id'] == 6)))) {
                                                    ?>
                                                    <button title="Only mark completed if data is not able to upload manually"
                                                            style="margin-top: 15px; margin-right: 15px;" type="submit" class="btn btn-danger pull-right">Mark
                                                        Complete
                                                    </button>
                                                <?php } ?>
                                            </form>
                                            ...
                                            if ($results['user_request_type_id'] != 8 && $results['status'] == 2 && $results['reply'] == 0) {
                                                ?>
                                                <button id="replysent" style="margin-top: 15px; margin-right:10px;"
                                                        onclick="markreplysent('<?php echo Helpers_Utilities::encrypted_key($results['request_id'], 'encrypt') ?>')"
                                                        class="btn btn-warning pull-right">Reply Sent
                                                </button>
                                            <?php } ?>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    function markreplysent(request_id) {
        $.ajax({
            url: '<?php echo URL::base() . "Userrequest/reply_sent?request_id="; ?>' + request_id,
