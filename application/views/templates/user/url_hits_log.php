...
<section class="content-header">
    <h1>
        ...
        URL Hits Log/History
        <small>Tracer</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo URL::site('Userdashboard/dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">URL Hits Log/History</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                <form id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userreports/url_hits_log'); ?>">
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-search"></i> URL Hits Log/History</h3>
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="urlhitstable" class="table table-bordered table-striped" >
                                <thead>
                                    <tr>                                        
                                        <th class="no-sort">User Details</th>
                                        <th class="no-sort">User IP</th>
                                        <th class="no-sort">User Agent</th>
                                        <th class="no-sort">URL Hit</th>
                                        <th class="no-sort">URL Hit Status</th>
                                        <th>Activity Time</th>
                                    </tr>
                                </thead>
                                <tbody>
...
//                    "colReorder" : true,
                    ...
                    "mark": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userreports/ajaxurlhitslog', TRUE); ?>",
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('userreports/url_hits_log', TRUE); ?>';
    }
