...
<section class="content">
    <div class="container-fluid">
        <form id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('admitdatabank/msisdn_breakup_report_individual'); ?>">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#auditreport').dataTable(
                {"aaSorting": [[4, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('admindatabank/ajaxmsisdnbreakupreport', TRUE); ?>",
