...
<!--        <form id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userreports/audit_report_basic'); ?>">                    
            ...
            <div class="col-md-12">
                <div class="">
                    <div class="box box-primary">
                        <form role="form" name="advance_search_form" id="advance_search_form" class="ipf-form" action="<?php echo URL::site('userreports/audit_report_basic/'); ?>" method="POST">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#auditreport').dataTable(
                {//"aaSorting": [[2, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userreports/ajaxauditreportbasic', TRUE); ?>",
    ...
    function clearSearch() {
        ...
        window.location.href = '<?php echo URL::site('userreports/audit_report_basic', TRUE); ?>';
    }
    function excel(id) {
        $('#xport').val('excel');
