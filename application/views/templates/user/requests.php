<?php
$name_encrypted = Helpers_Utilities::encrypted_key($name, "encrypt");
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requeststatus').dataTable(
            {"aaSorting": [[4, "desc"]],
                ...
                //"bStateSave": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo URL::site('adminrequest/ajaxadminsentrequests?name='.$name_encrypted.$dquery, TRUE); ?>",
