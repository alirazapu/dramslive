...
<section class="content-header">
    <h1>
        ...
        Afghan Subscriber Detail
        <small>DRAMS</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo URL::site('Userdashboard/dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Accused Person</li>
    </ol>
</section>
<!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-search"></i> Accused Person</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="kpkperson" class="table table-bordered table-striped">
                                <thead>
                                    <tr> 
                                        <th width="160">Master Acc Number</th>
                                        <th width="100">Master Name</th>
                                        <th width="100">Master Pak Province</th>
                                        <th>Master Pak District</th>
                                        <th>Master Pak Tehsil</th>
                                        <th>CNIC</th>
                                        <th>Msisdn</th>
                                        <th>Status</th>
                                        <th>Site Lat</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#kpkperson').dataTable(
                {"aaSorting": [[1, "desc"]],
                    "bPaginate": true,
                    "bProcessing": true,
                   // "bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('user/ajaxafghanperson', TRUE); ?>",
                    "sPaginationType": "full_numbers",
                    "bFilter": true,
                    "bLengthChange": true,
                    "oLanguage": {
                        "sProcessing": "Loading...",
                        "sSearch": "Search by Name or MSISDN:",
