    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                ...
                <?php } ?>
                <form id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userreports/users_list'); ?>">
                    <div class="box box-default collapsed-box">
                        ...
                        <div class="box-body" style="<?php echo (!empty($search_post)) ? 'display:block;' : ''; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="field">User Status</label>
                                    <select class="form-control " name="is_active" id='is_block' onchange="showDiv(this)">
                                        <option value="def"> Please Select Type</option>
                                        <option <?php echo ((!empty($search_post['is_active']) && ($search_post['is_active'] == '1')) ? 'selected' : ''); ?> value="1"> Active</option>
                                        <option <?php echo ((!empty($search_post['is_active']) && ($search_post['is_active'] == '2')) ? 'selected' : ''); ?> value="2"> Inactive & Approved</option>
                                        <option <?php echo ((!empty($search_post['is_active']) && ($search_post['is_active'] == '3')) ? 'selected' : ''); ?> value="3"> Inactive & Unapproved</option>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-list"></i> User's List</h3>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#userslist').dataTable(
                {//"aaSorting": [[2, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userreports/ajaxuserslist', TRUE); ?>",
 ...
 function showDiv(elem) {
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('userreports/users_list', TRUE); ?>';
    }
    function excel(id){          
            $('#xport').val('excel');
            $('#search_form').submit();            
