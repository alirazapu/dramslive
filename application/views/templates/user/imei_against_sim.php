...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">IMEIs Against Sim</li>
    </ol>
</section>
<!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-search"></i>Active Phone Number</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#bpartysearch').dataTable( 
                {"aaSorting": [[1, "desc"]],
                   ...
                   // "bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('user/ajaximeiagainstsim', TRUE); ?>",
