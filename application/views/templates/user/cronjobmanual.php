                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="pad">
                                       ...
                                       <?php } ?>  
                                        ...
                                        <a target="_blank" class="blue btn-primary" href="<?=URL::site();?>cronjob/email_parse_phone_1"><i class="fa fa-circle-o"></i> Mobilink CDR Parse</a>
                                        <a target="_blank" class="blue btn-primary" href="<?=URL::site();?>cronjob/email_parse_phone_7"><i class="fa fa-circle-o"></i> Warid CDR Parse</a>
                                        <a target="_blank" class="blue btn-primary" href="<?=URL::site();?>cronjob/email_parse_phone_3"><i class="fa fa-circle-o"></i> Ufone CDR Parse</a>
                                        <a target="_blank" class="blue btn-primary" href="<?=URL::site();?>cronjob/email_parse_phone_6"><i class="fa fa-circle-o"></i> Telenor CDR Parse</a>
                                        <a target="_blank" class="blue btn-primary" href="<?=URL::site();?>cronjob/email_parse_phone_4"><i class="fa fa-circle-o"></i> Zong CDR Parse</a>
