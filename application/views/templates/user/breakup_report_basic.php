...
<!--        <form id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('admindatabank/breakup_report'); ?>">
            ...
            <div class="col-md-12">
                <div class="">
                    <div class="box box-primary">
                        <form role="form" name="advance_search_form" id="advance_search_form" class="ipf-form" action="<?php echo URL::site('admindatabank/breakup_report/'); ?>" method="POST">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-search"></i> Breakup Report</h3>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#auditreport').dataTable(
                {//"aaSorting": [[2, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('admindatabank/ajaxbreakupreportbasic', TRUE); ?>",
    ...
    function clearSearch() {
        ...
        window.location.href = '<?php echo URL::site('admindatabank/breakup_report', TRUE); ?>';
    }
    function excel(id) {
        $('#xport').val('excel');
