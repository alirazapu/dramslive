    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                ...
                <form id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('Userreports/request_breakup_district/?id=' . $id); ?>">
                    <div class="box box-default collapsed-box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body" style="<?php echo (!empty($search_post['startdate']) && !empty($search_post['enddate'])) ? 'display:block;' : ''; ?>">                                                                                       
                            <div id="blocktohide">
                                <div class="col-md-4">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        ?>
                        <h3 class="box-title"><i class="fa fa-list"></i> Requests Breakup (District) <u> <?php echo ( $duration_flag ); ?> </u> </h3>
    ...
    $(document).ready(function () {
        ...
        objDT = $('#telcoreports').dataTable(
                {"aaSorting": [[0, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('Userreports/ajaxrequestbreakupreportdist', TRUE); ?>",
