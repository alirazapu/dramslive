    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                ...
                <form id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('Adminreports/verisys_response_report'); ?>">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-list"></i> Verisys Daily Report</h3>
                            ...
                            <table id="telcoreports" class="table table-bordered table-striped">
                                <thead>
                                    <tr>                                        
                                        ...
                                        <th class="no-sort">Total Response</th>
                                        <th class="no-sort">View Breakup</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    $(document).ready(function () {
        ...
        objDT = $('#telcoreports').dataTable(
                {"aaSorting": [[1, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('Adminreports/ajaxverisysresponse', TRUE); ?>",
...
//Date picker
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('Adminreports/verisys_response_report', TRUE); ?>';
    }
    function excel(id){          
            $('#xport').val('excel');
            $('#search_form').submit();            
