        ...
        <div class="row">
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                     ( &nbsp; <span class="blink">Already Sent Requests: <b><?php echo Helpers_Utilities::get_family_tree_sent_requests();?></b> </span> &nbsp;)
                </div>
                <?php
                if (!empty($message)) {
                    ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requeststatus').dataTable(
                {"aaSorting": [[5, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userrequest/ajaxuserrequeststatusfamilytree', TRUE); ?>",
    ...
    function requestmanualsent(request_id) {
        $.ajax({url: '<?php echo URL::base() . "Userrequest/automanualrequestsend/"; ?>' + request_id, success: function (result) {
            refreshGrid();       
        }});
    }    
