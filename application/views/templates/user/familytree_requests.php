...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Family Tree Requests</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="container-fluid">
        ...
        <div class="box box-primary">
            <div class="box">                 
                ...
                <form role="form" name="search_form" id="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userrequest/familytree_requests'); ?>" >
...
?>                                                     
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Family Tree Request Status</label>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="col-xs-4">
                            <h3 class="box-title"><i class="fa fa-list"></i> Family Tree Request</h3>
                        </div>
                        <div class="col-xs-4">
                            <a title="Upload Bulk Verisys" href="javascript:uploadbulkverisys()" class="btn btn-primary btn-small" style="float: right;"><i class="fa fa-upload"></i>  Upload Bulk FamilyTree's</a>
                        </div>
                        <div class="col-xs-4">
...
<div class="modal modal-info fade" id="family_tree">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Proceed Family Tree Request</h4>
            </div>
            <form class="" name="familytreepics" id="familytreepics" action="<?php echo url::site() . 'personprofile/update_personfamilytreerequest' ?>"  method="post" enctype="multipart/form-data" >
                ...
                <div class="modal-body" style='background-color: #fff !important; color: black !important; '>
                    ...
                    <div id="manualuploadimeicdr" style="display:block;margin-top: 5px;margin-bottom: 5px;" class="col-md-12">                                            
                        ...
                        <div class="col-md-12" style="background-color: #fff;color: black">
                            ...
                            <div class="form-group col-md-12"> 
                                <label for="personfamilytree">Upload<small>   (JPG,GIF,PNG and PDF files only)</small></label>
                                <input type="file" accept=".jpg,.gif,.png,.pdf" id="personfamilytree" name="personfamilytree" placeholder="Select Image">
                            </div> 
                            <div class="form-group col-sm-12" >
                                <hr class="style14 ">
                            </div>
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requeststatus').dataTable(
                {"aaSorting": [[4, "desc"]],
                    ...
                    "mark": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userrequest/ajaxuserfamilytreerequests', TRUE); ?>",
...
// request update
    $(document).ready(function (e) {
        $('#familytreepics').on('submit', (function (e) {
            e.preventDefault();
            var formData = new FormData(this);
            if ($('#familytreepics').valid())
            {
                $.ajax({
                    type: 'POST',
                    ...
                    success: function (data) {
                        document.getElementById("familytreepics").reset();
                        $("#family_tree").modal("hide");
                        if (data == 1) {
...
//    });
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('userrequest/familytree_requests', TRUE); ?>';
    }
    function excel(){    
            $('#xport').val('excel');
            $('#search_form').submit();            
    ...
    function uploadbulkverisys(){   
        window.location.href = '<?php echo URL::site('userrequest/bulk_familytree_requests', TRUE); ?>';
    }
