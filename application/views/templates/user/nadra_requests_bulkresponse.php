    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                ...
                <form role="form" name="verisys_temp_upload" id="verisys_temp_upload" class="ipf-form" method="POST" action="<?php echo URL::site('Personprofile/nadra_requests_temp_upload'); ?>" >
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">                                        
                                    <div class="form-group">                                            
                                        <input multiple type="file" accept=".jpg,.gif,.png" id="personverysis" name="personverysis[]" placeholder="Select Image">                                              
                                    </div>                                       
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#temp_verisys').dataTable(
                {"aaSorting": [[3, "desc"]],
                    ...
                    "mark": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userrequest/ajaxusernadrarequestsbulk', TRUE); ?>",
    ...
    function syncverisyswithrequests() {
        $("body").addClass("loading");
            $.ajax({
                url: "<?php echo URL::site("Verisyssync/sync_temp_uploaded_verisys"); ?>",
                cache: false,
                //dataType: "text",
                dataType: 'html',
                success: function (msg) {
