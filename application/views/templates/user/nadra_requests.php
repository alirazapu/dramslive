    ...
    <div class="container-fluid">
        ...
        <div class="box box-primary">
            <div class="box">                 
                ...
                <form role="form" name="search_form" id="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userrequest/nadra_requests'); ?>" >
...
<div class="modal modal-info fade" id="process_nadra_verysis">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="" name="veriysispics" id="veriysispics" action="<?php echo url::site() . 'personprofile/update_personverysisrequest/' ?>"  method="post" enctype="multipart/form-data" >  
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requeststatus').dataTable(
                {"aaSorting": [[4, "desc"]],
                    ...
                    "mark": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userrequest/ajaxusernadrarequests', TRUE); ?>",
...
//    });
    ...
    function uploadbulkverisys(){   
        window.location.href = '<?php echo URL::site('userrequest/bulk_nadra_requests', TRUE); ?>';
    }
    ...
    function cancelnadra(request_id){
        $.confirm({
            ...
            'buttons'   : {
                'Yes'   : {
                    ...
                    'action': function(){
                        $.ajax({
                            url: "<?php echo URL::site("Userrequest/cancel_nadra"); ?>",
                            type: 'POST',
