...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li> User's Report </li>
        <li class="active">Record Search Log/History</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                ...
                <form id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userreports/no_record_search'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="field" id='field'>
                                        ...
                                        <option <?php echo ((!empty($search_post['field']) && ($search_post['field'] == 'searched')) ? 'selected' : ''); ?> value="searched"> Searched</option>                                        
                                        <option <?php echo ((!empty($search_post['field']) && ($search_post['field'] == 'searchkey')) ? 'selected' : ''); ?> value="searchkey"> Search Key</option>
                                    </select>
                                </div>          
                            </div>
                            <!-- /.col -->
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <h3 class="box-title"><i class="fa fa-search"></i> Record Search Log/History</h3>
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="norecordsearch" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th class="no-sort">User Name</th>
                                        <th class="no-sort">User Type</th>
                                        <th class="no-sort">Searched</th>                                        
                                        <th class="no-sort">Search Key</th>                                        
                                        <th>Search Time</th>                                        
                                    </tr>
                                </thead>
                                <tbody>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#norecordsearch').dataTable(
                {"aaSorting": [[4, "desc"]],
                    "bPaginate": true,
                    "bProcessing": true,
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userreports/ajaxnorecordsearch', TRUE); ?>",
                    "sPaginationType": "full_numbers",
                    "bFilter": true,
                    "bLengthChange": true,
                    "oLanguage": {
                        "sProcessing": "Loading...",
                        "sSearch": "Search By User Name,Search Type or Search Key:"
                    },
                    "columnDefs": [{
                            "targets": 'no-sort',
                            "orderable": false,
   ...
   $("#search_form").validate({
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('userreports/no_record_search', TRUE); ?>';
    }
    function excel(id){          
            $('#xport').val('excel');
            $('#search_form').submit();            
