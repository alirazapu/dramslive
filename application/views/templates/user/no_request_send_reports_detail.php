...
//                $request_type = ( isset($request_typ) ) ? Helpers_Utilities::get_request_type($request_typ) : 'NA';
                ?>  
                <form role="form" id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('admindatabank/no_request_send_reports_detail/'); ?>" >
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-search"></i> Request Send Log of: <u> <?php echo $user_name ?></u> &nbsp; against <u><?php echo "Nadra verisys" ?></u></h3>
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requestsend').dataTable(
                {//"aaSorting": [[2, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('admindatabank/ajaxuserrequestsendreportsdetail', TRUE); ?>",
