...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"></i>User's Favourite User</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="container-fluid">
        <div class="">
            <div class="box box-primary">
                <form role="form" name="search_form" id="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userreports/users_favourite_user'); ?>" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control " name="field" id='field' onchange="showDiv(this)">
                                        <option  value="def">Please Select any Option</option>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-search"></i> User's Favourite User</h3>
                    ...
                    <div class=" box-body">
                        <div class="table-responsive">
                            <table id="usersfavouriteuser" class="table  table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>User Type</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#usersfavouriteuser').dataTable(
                {//"aaSorting": [[2, "desc"]],
                    "bPaginate": true,
                    "bProcessing": true,
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userreports/ajaxusersfavouriteuser', TRUE); ?>",
    ...
    function clearSearch() {
        window.location.href = '<?php echo URL::site('userreports/users_favourite_user', TRUE); ?>';
    }
