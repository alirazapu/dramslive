...
<section class="content">
    <div class="container-fluid">
        ...
        ?>
        <form role="form" id="search_form" name="search_form" class="ipf-form" method="POST" action="<?php echo URL::site('userreports/no_request_send_type/'); ?>" >
            <input type="hidden"  placeholder="mm/dd/yyyy" class="form-control" value="<?php echo (!empty($search_post['userid']) ? $use_i : ""); ?>" name="userid">
            <input type="hidden"  placeholder="mm/dd/yyyy" class="form-control" value="<?php echo (!empty($search_post['sdate']) ? $search_post['sdate'] : ""); ?>" name="sdate">
            <input type="hidden"  placeholder="mm/dd/yyyy" class="form-control" value="<?php echo (!empty($search_post['edate']) ? $search_post['edate'] : ''); ?>" name="edate">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        ?>
                        <h3 class="box-title"><i class="fa fa-search"></i>Request Send Log of User <u> <?php echo isset($use_i) ? Helpers_Utilities::get_user_name($use_i) : "UnKnown" ?></u></h3>
    ...
    $(document).ready(function () {
        ...
        objDT = $('#requestsend').dataTable(
                {"aaSorting": [[5, "desc"]],
                    ...
                    //"bStateSave": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo URL::site('userreports/ajaxuserrequestsendtype', TRUE); ?>",
