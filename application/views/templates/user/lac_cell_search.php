...
<!--                        <h3 class="box-title"><i class="fa fa-search"></i> Sims Against Lac and Cell ID</h3>-->
<!--                    </div>-->
                    <!-- /.box-header -->
                    <div class="box-body">
    ...
    $(document).ready(function () {
        ...
        objDT = $('#laccellsearch').dataTable(
            {"aaSorting": [[1, "desc"]],
                ...
                // "bStateSave": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo URL::site('user/ajaxlaccellsearch/?cell='.$search_post['cell'].'&lac='.$search_post['lac'].'&count='.$search_post['count'], TRUE); ?>",
